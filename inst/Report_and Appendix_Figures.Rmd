...
source(paste0(main.folder,"/load.data.r"))
...
```{r basin-scale-climate, fig.width = 3.2, fig.height = 3}
...
```{r Domoic_Acid_Monthly_byState_Clams_and_Crabs, fig.width = 6.2, fig.height = 2.55}
...
```{r snowwater, fig.height=3.5, fig.width = 6.2}  
source('reset.DFs.R')
...
```{r flow.esu, fig.width=6.2, fig.height=2.5}
par(mfrow = c(1,3))
source('reset.DFs.R')
...
## Seabirds
```{r seabird.density, fig.width=6.2, fig.height=3}
source("reset.DFs.R") 
...
```{r DomoicAcid.WA, fig.width = 3.2, fig.height = 3.5}
source('reset.DFs.R')
...
```{r DomoicAcid.CA, fig.width = 3.2, fig.height = 3}
source('reset.DFs.R')
...
```{r stream.temp.ecoregion, fig.width = 6.2, fig.height = 3.5}
source("reset.DFs.R")
...
```{r Nforage.ts, fig.width = 6.2, fig.height = 4.5}
source("reset.DFs.R")
...
### biomass 
```{r HMS.biomass, fig.width = 6.2, fig.height=3.0}
par(mfrow = c(4,2))
source("reset.DFs.R")
...
### recruitment 
```{r HMSrecruitment, fig.width = 6.2, fig.height=2.5}
source("reset.DFs.R")
...
```{r seabirds.ts, fig.width = 6.2, fig.height=2.5}
source("reset.DFs.R") 
seabirdsNCC = load.data("Seabirds","Seabird - No CC at-sea densities")
seabirdsCCC = load.data("Seabirds","Seabird - Ce CC at-sea densities")
seabirdsSCC = load.data("Seabirds","Seabird - So CC at-sea densities")
...
```{r SeabirdMortality_Central, fig.width = 3.2, fig.height=4}
source("reset.DFs.R")
...
```{r SeabirdMortality_North, fig.width = 3.2, fig.height=4}
source("reset.DFs.R")
...
```{r revenue, fig.width = 6.2, fig.height = 3.5} 
source("reset.DFs.R")
...
```{r CArevenue, fig.width = 6.2, fig.height = 3.5} 
source("reset.DFs.R")
...
```{r ORrevenue, fig.width = 6.2, fig.height = 3.5} 
source("reset.DFs.R")
df = load.data("Human Activities","revenue")
# df = df[grep("Revenue", df$metric),]
...
```{r WArevenue, fig.width = 6.2, fig.height = 4.5} 
source("reset.DFs.R")
